...
with DAG(
    ...
    with TaskGroup('poblar_tablas') as poblar_tablas_dimensiones:
        ...
        poblar_municipios = PostgresOperator(
            ...
            sql=insert_query_city(csv_path = "dimension_municipios")
        )
        ...
        poblar_recursos = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_customer(csv_path ="dimension_recursos")
        )
        ...
        poblar_fechas = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_date(csv_path = "dimension_fechas")
        )
        ...
        poblar_actividades_mineras = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_employee(csv_path = "dimension_actividades_mineras")
        )
        ...
        poblar_homicidios = PostgresOperator(
            ...
            postgres_conn_id='postgres_localhost',
            sql=insert_query_stock(csv_path = "dimension_homicidios)
        )
